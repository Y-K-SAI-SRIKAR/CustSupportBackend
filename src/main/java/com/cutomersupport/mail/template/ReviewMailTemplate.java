...
public class ReviewMailTemplate {
    ...
    public String buildAckMail(String name) {
        ...
        return "<div style=\"font-family: 'Noto Serif', serif; font-style: italic; font-weight: 300; max-width: 600px; margin: auto; padding: 30px; background-color: #fcfcfc; border: 1px solid #CCBEB1; border-radius: 8px; color: #4C84D0;\">"
                ...
                + "<p style=\"font-size: 16px; line-height: 1.6; color: #333333;\">Thank you for taking the time to share your experience with Wavepoint.</p>"

                + "<p style=\"font-size: 16px; line-height: 1.6; color: #333333;\">Honest feedback from our users helps us understand what is working well and where we can improve. Your insights are valuable to our continuous effort to make Wavepoint a better experience for every team.</p>"
