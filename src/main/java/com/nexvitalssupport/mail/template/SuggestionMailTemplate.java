...
public class SuggestionMailTemplate {
	...
	public String buildAckMail(String name) {
		return "<div style=\"font-family: 'Noto Serif', serif; font-style: italic; font-weight: 300; max-width: 600px; margin: auto; padding: 30px; background-color: #fcfcfc; border: 1px solid #CCBEB1; border-radius: 8px; color: #4C84D0;\">"
				...
				+ "<p style=\"font-size: 16px; line-height: 1.6; color: #333333;\">We deeply appreciate you taking the time to share your perspective with us.</p>"
				+ "<p style=\"font-size: 16px; line-height: 1.6; color: #333333;\">We believe the best innovation comes from those who experience our technology daily. Your suggestion has been logged and will be evaluated by our Research and Development team.</p>"
