...
public class SubscriberMailTemplate {
	...
	public String buildWelcomeMail(String toEmail) {
		...
		return "<div style=\"font-family: 'Noto Serif', serif; font-style: italic; font-weight: 300; max-width: 600px; margin: auto; padding: 30px; background-color: #fcfcfc; border: 1px solid #CCBEB1; border-radius: 8px; color: #4C84D0;\">"
				...
				+ "<h2 style=\"color: #4C84D0; margin: 0; font-size: 24px;\">Welcome to NexVitals</h2>"
				+ "</div>"
				+ "<p style=\"font-size: 16px; line-height: 1.6; color: #333333;\">Hello,</p>"
				+ "<p style=\"font-size: 16px; line-height: 1.6; color: #333333;\">Thank you for subscribing to NexVitals updates.</p>"
				+ "<p style=\"font-size: 16px; line-height: 1.6; color: #333333;\">You are now connected to a smarter ecosystem of care. You will receive the latest news regarding product breakthroughs, emergency protocol changes, and healthcare partner announcements directly to your inbox.</p>"
				...
				+ "<p><em>Your Vitals Never Sleep. Neither Do We.</em></p>"
